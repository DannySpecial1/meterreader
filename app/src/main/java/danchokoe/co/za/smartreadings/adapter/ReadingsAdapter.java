package danchokoe.co.za.smartreadings.adapter;
...
import danchokoe.co.za.smartreadings.R;
...
public class ReadingsAdapter extends CursorAdapter {
    ...
    public static class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            account_numberView = view.findViewById(R.id.account_number);
            reading_dateView = view.findViewById(R.id.reading_date);
            water_readingView = view.findViewById(R.id.water_reading);
            electricity_readingView = view.findViewById(R.id.electricity_reading);
