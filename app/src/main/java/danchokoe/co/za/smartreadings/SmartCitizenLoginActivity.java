...
import danchokoe.co.za.smartreadings.service.SmartCitizenIntentService;
...
public class SmartCitizenLoginActivity extends Activity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(username)) {
            ...
            mRegisterEmailView  = findViewById(R.id.register_email);
            mRegisterPasswordView     = findViewById(R.id.register_password);
            mRegisterPasswordConfirmView = findViewById(R.id.register_password2);
            ...
            Button mSignButton = findViewById(R.id.email_register);
            ...
            Button mLogin = findViewById(R.id.email_sign_in);
    ...
    public class SmartCitizenIntentServiceReceiver extends BroadcastReceiver {
        ...
        public static final String PROCESS_RESPONSE = "danchokoe.co.za.smartreadings.intent.action.PROCESS_RESPONSE";
